#!/usr/bin/env node
/**
 * scripts/normalizePublicImageFilenames.js
 *
 * Safe, non-destructive normalization of filenames under public/images.
 * By default the script runs in dry-run mode and prints a proposed mapping.
 * Use --apply to actually rename files.
 *
 * It writes a mapping file at scripts/image-filename-map.json for review.
 */

#!/usr/bin/env node
/**
 * scripts/checkImageEndpoints.js
 *
 * Scans public/images/<folders> and checks whether the backend media and storage
 * endpoints return a successful HEAD response for each filename. Useful to
 * locate images that will fail when deployed.
 *
 * Usage:
 *   node scripts/checkImageEndpoints.js
 *
 * The script reads VITE_BACKEND_URL from environment if present, otherwise

#!/usr/bin/env node
/**
 * scripts/generateImageMappingReport.js
 *
 * Compares files under public/images with the existing JSON manifests in src/data
 * and reports missing and extra files per folder.
 */
